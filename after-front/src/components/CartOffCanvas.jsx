                ...
                {carrello.length === 0 ? (
                    ...
                    <>
                        {carrello.map(prodotto => {
                            const discount = prodotto.original_price && prodotto.price < prodotto.original_price
                                ? Math.round(((prodotto.original_price - prodotto.price) / prodotto.original_price) * 100)
                                : 0;
                                ...
                                <div key={prodotto.id} className="carrello-item text-white d-flex align-items-center mb-3">
                                    ...
                                    <div className="carrello-info flex-grow-1">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <span className="carrello-prezzo fw-bold me-2">{(prodotto.price * prodotto.quantita).toFixed(2)}€</span>
                                            
                                            {/* Mostra la percentuale di sconto solo se esiste */}
                                            {discount > 0 && (
                        ...
                        <NavLink to="/utente" className="w-100 mt-3 p-3">
                            <button className="order-button text-white btn w-75 mt-3 p-3" onClick={handleClose}>
